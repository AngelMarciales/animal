...
public class AnimalService {
    ...
    public List<NumberByCategory> getNumberByCategory() throws IOException {
        List<String> listAnimal = Files.readAllLines(Paths.get(filePath));
        ...
        List<NumberByCategory> numberAnimals = new ArrayList<>();
        for (Map.Entry<String, Integer> entry : categoryCountMap.entrySet()) {
            numberAnimals.add(new NumberByCategory(entry.getKey(), entry.getValue()));
        }
